...
class LYMessageViewController: LYBaseViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func creatDataSource() {
        //列表展示的数据源
        self.dataArray = ["closures", "return cycle", "function calling"]
        //列表要跳转类的数据源
        self.classArray = ["ClosuresViewController", "ReturnCycleViewController", "FunctionViewController"]
    }
